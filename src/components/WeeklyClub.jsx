...
export default function WeeklyClub() {
    return (
        <section className="relative py-24 overflow-hidden bg-[#0A192F] border-y border-white/5">
            {/* Background Decorative Elements */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-sunset/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2" />
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-ocean/20 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2" />
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <div className="inline-flex items-center gap-2 bg-white/10 text-white text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider mb-6 border border-white/20">
                            SideOut Weekly
                        </div>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-white">
                            SideOut Weekly: <br />
                            <span className="text-gray-300">The Ultimate Employee Wellness Club</span>
                        </h2>
                        ...
                        <div className="grid gap-6 mb-10">
                            {[
                                ...
                                <div key={i} className="flex gap-4 items-start">
                                    <div className="mt-1 bg-white/10 p-2 rounded-lg shadow-sm border border-white/5">
                                        {item.icon}
                                    </div>
                                    <div>
                        ...
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="inline-flex items-center gap-2 bg-sunset text-white hover:bg-[#e04f44] font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all"
                        >
                    ...
                    >
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                            <img
